      ...
      <div class="content-area">
        ...
        <div class="top-bar">
          ...
          <div v-if="posterDetail" class="user-info">
            ...
            <img v-if="posterDetail?.userAvatar" :src="processImageData(posterDetail.userAvatar)" alt="用户头像" class="user-avatar" />
            <span v-else class="user-avatar-placeholder">{{ posterDetail?.userName?.charAt(0).toUpperCase() || 'U' }}</span>
          </div>
        </div>
        ...
        <div v-else-if="postData">
          ...
          <div class="post-content">
            ...
            <div class="post-actions">
              ...
              >
                <img v-if="likeIconUrl" :src="likeIconUrl" alt="点赞" class="action-icon" style="width: 16px; height: 16px; filter: brightness(0) invert(1);" />
              ...
              <button 
                ...
                :disabled="actionLoading"
              >
                <img v-if="collectionIconUrl" :src="collectionIconUrl" alt="收藏" class="action-icon" style="width: 16px; height: 16px; filter: brightness(0) invert(1);" />
          ...
          <div class="comments-section">
            ...
            <div class="comment-input-container">
              <img v-if="userAvatar" :src="userAvatar" alt="用户头像" class="comment-input-avatar" />
              <span v-else class="comment-input-avatar-placeholder">{{ username?.charAt(0).toUpperCase() || 'U' }}</span>
            ...
            <div v-else class="comments-list">
              ...
              <div 
                ...
                class="comment-item"
              >
                <img v-if="comment.userAvatar" :src="processImageData(comment.userAvatar)" alt="用户头像" class="comment-avatar" />
                <span v-else class="comment-avatar-placeholder">{{ comment.userName?.charAt(0).toUpperCase() || 'U' }}</span>
